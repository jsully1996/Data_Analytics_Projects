...
Next, we transform the data ([Transform and Load.ipynb](https://github.com/jsully1996/Data_Analytics_Projects/blob/master/Insurance_Customer%20_Churn/Preprocessing_and_ETL/Transform%20and%20Load.ipynb)) so as to make it easier to process for the ML model. This is done by converting categorical columns to corresponding numeric values, a process called One Hot Encoding. After all this is done we then proceed to Load the data into a local MySQL database.<br><br>
...
<center><img src="./Data/img/Webform.png" style="text-align:center; display:block;"></center><br>
