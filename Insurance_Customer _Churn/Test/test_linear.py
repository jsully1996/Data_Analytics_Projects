...
import itertools
churn_df = pd.read_csv('D:\Project_work\Data\Master_Dataset_1 - Copy.csv')
...
ss3 = mean_squared_error(predictions, test[target])
#print("Error percentage in model3 :")
#print(ss3)

test=test[test.Churn!=0]
test.to_csv('outside.csv')
